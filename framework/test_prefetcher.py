#!/usr/bin/env python
# ./build/ALPHA_SE/m5.opt --trace-flags=HWPrefetch configs/example/se.py --detailed --caches --l2cache --l2size=512kB --prefetcher=policy=proxy --prefetcher=on_access=True --cmd /path/to/testprogram
"""
